...
public class MainActivity extends Activity {
	...
	public void connectOpen(View view){
    	try{
    	    ...
    	    if(res !=1){
    	    	Toast.makeText(this, "Conexion Agregada Exitosamente", Toast.LENGTH_SHORT).show();
    	    	boolean b = wifi.enableNetwork(res, true);        
    	    	Toast.makeText(this, "Network Activa: "+b, Toast.LENGTH_SHORT).show();
    	    }//end if
    	}catch(Exception e){
	...
	public void connectWep(View view){
    	try{
    		WifiManager wifi = (WifiManager) getSystemService(Context.WIFI_SERVICE);
    		WifiConfiguration wc = new WifiConfiguration();
    		wc.SSID = "\"".concat("dlink").concat("\"");
	...
	public void connectWpa(View view){
    	try{
    		WifiManager wifi = (WifiManager) getSystemService(Context.WIFI_SERVICE);
    		WifiConfiguration wc = new WifiConfiguration();
    		wc.SSID = "\"".concat("dlink").concat("\"");
